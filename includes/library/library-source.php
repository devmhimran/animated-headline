<?php
		 ...
		 */
		class Rig_Templates extends Source_Base {
			 ...
			 */
			public static $api_info_url = 'https://gitlab.com/anonnaabir/rig-elements-api/raw/master/info.json';


			private static $api_get_template_content_url = 'https://gitlab.com/anonnaabir/rig-elements-api/raw/master/templates/%s.json';
			/**
